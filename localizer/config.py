"""Configuration models for the standalone localizer."""
...
class SearchConfig:
    ...
    local_turn_limit_deg: float = 12.0
    speed_step_mps: float = 2.0
    max_delta_v_mps_per_window: float = 4.0
    recovery_speed_multiplier: float = 1.0
    global_speed_min_multiplier: float = 0.6
    global_speed_max_multiplier: float = 1.4
    ...
    absolute_height_sigma_m: float = 10.0
    confidence_min_score_gap: float = 0.01
    turn_penalty_weight: float = 0.30
    turn_penalty_scale_deg: float = 10.0
    speed_change_penalty_weight: float = 0.25
